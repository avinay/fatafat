...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if(navigator.connection.type==Connection.NONE){
            if(localStorage.getItem("catnewsfeed") === null){
            ...
            document.location.href = "refresh.html";
                  ...
                  var local_data=JSON.parse(localStorage.getItem("catnewsfeed"));
              ...
              $.get("http://avinay.com/newshots/getPostCat", {
                ...
                if(result.success == true){
                    ...
                    localStorage.removeItem("catnewsfeed");
                    localStorage.setItem('catnewsfeed',JSON.stringify(result));
                    if(localStorage.getItem("catnewsfeed") === null){
                    }else{
                    var local_data=JSON.parse(localStorage.getItem("catnewsfeed"));
                    //alert(local_data.counts);
