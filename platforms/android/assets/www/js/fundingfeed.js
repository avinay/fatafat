...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if(navigator.connection.type==Connection.NONE){
            if(localStorage.getItem("fundingnewsfeed") === null){
            ...
            document.location.href = "refresh.html";
                  ...
                  var local_data=JSON.parse(localStorage.getItem("fundingnewsfeed"));
              ...
              $.get("http://avinay.com/newshots/getPostCat", {
                ...
                if(result.success == true){
                    ...
                    localStorage.removeItem("fundingnewsfeed");
                    localStorage.setItem('fundingnewsfeed',JSON.stringify(result));
                    if(localStorage.getItem("fundingnewsfeed") === null){
                    }else{
                    var local_data=JSON.parse(localStorage.getItem("fundingnewsfeed"));
                    //alert(local_data.counts);
