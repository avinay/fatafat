...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if(navigator.connection.type==Connection.NONE){
            if(localStorage.getItem("gadgetnewsfeed") === null){
            ...
            document.location.href = "refresh.html";
                  ...
                  var local_data=JSON.parse(localStorage.getItem("gadgetnewsfeed"));
              ...
              $.get("http://avinay.com/newshots/getPostCat", {
                ...
                if(result.success == true){
                    ...
                    localStorage.removeItem("gadgetnewsfeed");
                    localStorage.setItem('gadgetnewsfeed',JSON.stringify(result));
                    if(localStorage.getItem("gadgetnewsfeed") === null){
                    }else{
                    var local_data=JSON.parse(localStorage.getItem("gadgetnewsfeed"));
                    //alert(local_data.counts);
