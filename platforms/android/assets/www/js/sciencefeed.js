...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if(navigator.connection.type==Connection.NONE){
            if(localStorage.getItem("sciencenewsfeed") === null){
            ...
            document.location.href = "refresh.html";
                  ...
                  var local_data=JSON.parse(localStorage.getItem("sciencenewsfeed"));
              ...
              $.get("http://avinay.com/newshots/getPostCat", {
                ...
                if(result.success == true){
                    ...
                    localStorage.removeItem("sciencenewsfeed");
                    localStorage.setItem('sciencenewsfeed',JSON.stringify(result));
                    if(localStorage.getItem("sciencenewsfeed") === null){
                    }else{
                    var local_data=JSON.parse(localStorage.getItem("sciencenewsfeed"));
                    //alert(local_data.counts);
