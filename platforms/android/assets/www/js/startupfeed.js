...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if(navigator.connection.type==Connection.NONE){
            if(localStorage.getItem("startupnewsfeed") === null){
            ...
            document.location.href = "refresh.html";
                  ...
                  var local_data=JSON.parse(localStorage.getItem("startupnewsfeed"));
              ...
              $.get("http://avinay.com/newshots/getPostCat", {
                ...
                if(result.success == true){
                    ...
                    localStorage.removeItem("startupnewsfeed");
                    localStorage.setItem('startupnewsfeed',JSON.stringify(result));
                    if(localStorage.getItem("startupnewsfeed") === null){
                    }else{
                    var local_data=JSON.parse(localStorage.getItem("startupnewsfeed"));
                    //alert(local_data.counts);
