...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if(navigator.connection.type==Connection.NONE){
            if(localStorage.getItem("eventnewsfeed") === null){
            ...
            document.location.href = "refresh.html";
                  ...
                  var local_data=JSON.parse(localStorage.getItem("eventnewsfeed"));
              ...
              if(count >= 50){
                            $.get("http://avinay.com/newshots/getPostCat", {
                              ...
                              if(result.success == true){
                                  ...
                                  localStorage.removeItem("eventnewsfeed");
                                  localStorage.setItem('eventnewsfeed',JSON.stringify(result));
                                  if(localStorage.getItem("eventnewsfeed") === null){
                                  }else{
                                  var local_data=JSON.parse(localStorage.getItem("eventnewsfeed"));
                                  //alert(local_data.counts);
